...
Selenium and RSS based Java job scraper. That's it ! What you do with that tool is up to you.

## Installing

### With Maven

You can add `io.makepad.jobfinder` in your `pom.xml` file as a dependency.
...
We're really sorry to hear that. Please [create a new issue](https://www.github.com/Makepad-fr/jobfinder/issues/new) and we'll try to fix it ASAP.
